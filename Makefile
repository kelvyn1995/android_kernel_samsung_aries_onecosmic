...
PATCHLEVEL = 6
SUBLEVEL = 35
EXTRAVERSION = .13_platypus_NEO_9-redux_v2
NAME = Yokohama
...
MODFLAGS	= -DMODULE -O2 -mtune=cortex-a8 -ftree-vectorize -ffast-math -fsingle-precision-constant -march=armv7-a -mfpu=neon
